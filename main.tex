...
\title{\textit{Design} dan Evaluasi \textit{Platform} Terintegrasi dengan \textit{Hybrid Conversational AI} dan \textit{Gamification} Berbasis \textit{Blockchain} untuk Meningkatkan \textit{User Engagement} dan Kesejahteraan Mahasiswa.}
% Program and the head of the program
\program{TEKNOLOGI INFORMASI}{AGUS BEJO}{<<NIP>>}
