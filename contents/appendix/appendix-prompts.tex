...
This section details the rubric used by the LLM-as-a-Judge (Sherlock Think Alpha) to evaluate the quality of responses generated by the Therapeutic Coach Agent (TCA).
