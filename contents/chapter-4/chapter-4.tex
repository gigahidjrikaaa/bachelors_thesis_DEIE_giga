...
\textbf{Calculation Procedure:}
\begin{enumerate}
    \item Generate SCA responses for all 10 coaching prompts via \lstinline {/api/v1/aika} endpoint
