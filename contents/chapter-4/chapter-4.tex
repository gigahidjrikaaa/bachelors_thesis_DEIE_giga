...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.5cm} p{3.5cm} p{5.5cm} p{2cm}}
        ...
        \midrule
        \textbf{RQ2: Autonomous Orchestration} & Workflow execution testing on orchestration suite (n=10) & Tool Call Success Rate, Retry Recovery Rate, State Transition Accuracy & Success Rate $\geq$ 95\% \\
        \midrule
        \textbf{RQ3: Strategic Proactivity} & Rubric scoring on coaching prompts (n=10) \& Code review/unit tests for privacy & Mean Rubric Score (1-5 scale), Boundary Behavior Accuracy, K-Anonymity Compliance & Score $\geq$ 3.5/5, 100\% Compliance \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    \centering
    \caption{RQ2: Autonomous Orchestration Evaluation Results.}
...
\section{RQ3: Strategic Proactivity Evaluation}
\label{sec:rq3}

\subsection{Evaluation Design}
This evaluation had a dual objective: to assess the quality of the agent-generated therapeutic content and to verify the system's capacity to generate \textbf{strategic institutional insights} safely.
...
\begin{table}[htbp]
    \centering
    \caption{RQ3: Strategic Proactivity (Quality) Results.}
...
\begin{table}[htbp]
    \centering
    \caption{RQ3: Strategic Proactivity (Privacy) Results.}
