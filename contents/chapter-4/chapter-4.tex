...
\begin{description}
    ...
    \item[Agent Reasoning Latency] for RQ1 measures the time in milliseconds (ms) from when a user message is received to when the system makes a classification decision. This is crucial for ensuring a fluid conversational experience. The median (p50) and 95th percentile (p95) values are reported.
