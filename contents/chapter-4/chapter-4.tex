...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.5cm} p{3.5cm} p{5.5cm} p{2cm}}
        ...
        \midrule
        \textbf{RQ2: Autonomous Orchestration} & Workflow execution (n=10) \& Rubric scoring (n=10) & State Transition Accuracy, Mean Rubric Score & Success $\geq$ 95\%, Score $\geq$ 3.5/5 \\
        \midrule
...
\begin{itemize}
    ...
    \item \textbf{Orchestration Test Suite (RQ2):} 10 structured conversation flows designed to test agent routing and error handling. These scenarios also feature multilingual inputs.
