...
This structure minimizes the "infinite loop" hallucinations common in cyclic multi-agent graphs and provides a deterministic execution path for safety-critical mental health interventions. The hierarchical relationship is illustrated in Figure \ref{fig:supervisor_hierarchy}.
