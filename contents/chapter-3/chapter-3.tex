...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|p{3.5cm}|c|p{5cm}|}
        ...
        \hline
        SCA & Gemini 2.5 Flash & 0.7 & Higher temperature for natural, empathetic response generation with CBT alignment \\
        \hline
        SDA & Gemini 2.5 Flash & 0.5 & Moderate temperature for procedural case management workflows with structured outputs \\
        \hline
